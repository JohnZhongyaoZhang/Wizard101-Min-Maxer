...
_STAT_DISPLAY_TABLE = {
    ...
    _fnv_1a(b"CanonicaMythFishingLuck"): f"Myth Fishing Luck",
    _fnv_1a(b"CanonicaShadowFishingLuck"): f"Shadow Fishing Luck",
    _fnv_1a(b"CanonicaStormFishingLuck"): f"Storm Fishing Luck",
